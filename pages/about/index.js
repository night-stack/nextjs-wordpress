        ...
        >
          <div className="w-1/2 mb-25">
            <div className="mb-7.5">
              <h1 className="text-witech-link text-xl">Let’s get acquainted</h1>
            </div>
            <div>
              <h1
            ...
            <div className="pt-5">
              <h1 className="text-white text-lg font-normal">
                We ensure quality and privacy in our work. We have professional
                teams with experience and expertise in application development.
                Our team consists of various devisions and can develop with many
                frameworks.
              </h1>
            </div>
          </div>
        ...
        <div className="flex justify-between pt-20">
          <div className="w-1/2">
            ...
            <div className="text-lg">
              Our goal is to create systems for your product development and to
              solve your business problems. We offer our services for small to
              medium-sized companies that want to optimize their performance. We
              ensure IT quality improvement of our companies and local
              businesses client by giving an full effort of out professional
              teams. We provide this effort to fully support technology
              development in Indonesia. especially in Medan.
            </div>
          </div>
          <div className="w-1/2">
            <img
